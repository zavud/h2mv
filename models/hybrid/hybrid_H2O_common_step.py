...
def common_step(self, batch):
    ...
    preds_nn, preds_hybrid, _, _ = self(forcing = forcing, static = static, states_initial = states_spinup)
    ...
    loss_sum = loss_tws_monthly + loss_et_monthly + loss_q_monthly + loss_swe + loss_fapar_monthly
